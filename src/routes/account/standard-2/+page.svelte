					...
					<div class="grid gap-6 sm:grid-cols-2">
						<div class="space-y-2">
							...
							<Input
								...
								on:input={(e) => (userProfile.name = e.target.value)}
							/>
						</div>
						<div class="space-y-2">
							...
							<Input
								...
								on:input={(e) => (userProfile.username = e.target.value)}
							/>
						</div>
						<div class="space-y-2 sm:col-span-2">
							...
							<Input
								...
								on:input={(e) => (userProfile.email = e.target.value)}
							/>
						</div>
						<div class="space-y-2 sm:col-span-2">
							...
							<Input
								...
								on:input={(e) => (userProfile.bio = e.target.value)}
							/>
						</div>
					</div>
					...
					<div class="space-y-8">
						<div class="flex items-center justify-between">
							...
							<Switch
								...
								on:change={(e) => (userProfile.notifications.email = e.target.checked)}
							/>
						</div>
